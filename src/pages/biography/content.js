const BioData = [
  {
    ko: `SCENT는 일렉트로닉 장르를 기반으로 Oceanhertz(프로듀서)와
            ...
            바람을 불러일으킨다.`,
    en: `SCENT is a team based on electronic genres, and it’s a team of two;
  ...
  {
    ko: `2021년 EP 앨범 [Thus, We Are]로 데뷔하고 다양한 데모곡으로 추가 활동을
    ...
    en: `Their debut album [Thus, We Are] sing about the happiness, anger,
